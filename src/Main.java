import BruteForce.DigitsSum;
import BruteForce.IndictDates;
import BruteForce.PlayGame;
import Others.*;
 ...
 * Indict Dates
 */
//        IndictDates id = new IndictDates();
//        int result = id.getYear(1, 2, 3);
//        System.out.println(result);
/**
 * Digits Sum
 */
//        DigitsSum ds = new DigitsSum();
//        int result = ds.lastDigit(999999999);
//        System.out.println(result);
/**
 * Play Game
 */
        PlayGame pg = new PlayGame();
        int[] you1 = {651, 321, 106, 503, 227, 290, 915, 549, 660, 115,
        ...
        int[] computer1 = {16, 127, 704, 614, 218, 67, 169, 621, 340, 319,
        ...
        int[] you2 = {100, 100, 100};
        int[] computer2 = {100, 100, 100};
        int[] you3 = {5, 15, 100, 1, 5};
        int[] computer3 = {5, 15, 100, 1, 5};
        int result = pg.saveCreatures(you1, computer1);
        System.out.println(result);
    }
}
